$(function () {
  ...
  $.getJSON('https://jonquil-rhinoceros-3096.twil.io/capability-token')
...
//        document.getElementById('button-call').style.display = 'none';
        ...
        document.getElementById('callMini').style.display = 'block';
        document.getElementById('callingBox').style.display = 'block';
...
//        document.getElementById('button-hangup').style.display = 'none';
        ...
        document.getElementById('callingBox').style.display = 'none';
        document.getElementById('callClose').style.display = 'block';
      ...
      Twilio.Device.incoming(function (conn) {
        ...
        var archEnemyPhoneNumber = '+19706763654';
  ...
  document.getElementById('button-call').onclick = function () {
    ...
    var name = $(".allicant-name").html();
    $(".CustName").html(name);
    $(".CustNo").html("Calling to : "+params.To);
    console.log('Calling ' + params.To + '...');
    Twilio.Device.connect(params);
  };
  document.getElementById('button-call1').onclick = function () {
    // get the phone number to connect the call to
    var params = {
      To: document.getElementById('phone-number1').value
    };
    var name = $(".allicant-name").html();
    $(".CustName").html(name);
    $(".CustNo").html("Calling to : "+params.To);
  ...
  document.getElementById('button-call2').onclick = function () {
    // get the phone number to connect the call to
    var params = {
      To: document.getElementById('phone-number2').value
    };
    var name = $(".allicant-name").html();
    $(".CustName").html(name);
    $(".CustNo").html("Calling to : "+params.To);
