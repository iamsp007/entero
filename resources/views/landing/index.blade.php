...
<!--=====HEADER START=======-->
           ...
           <div class="col-12">
             <div class="header-elements">
               ...
               <div class="header2-buttons">
                    <div class="button">
                      <a class="theme-btn1" href="{{ url('/login') }}">Client Login <span><i class="fa-solid fa-arrow-right"></i></span></a>
                    </div>
               </div>
   ...
   <!--=====HEADER END=======-->
              ...
              <div class="col-12">
                <div class="mobile-header-elements">
                  <div class="mobile-logo">
                    <a href="index1.html"><img src="{{ asset('landing/assets/img/logo/header-logo1.png')}}" alt=""></a>
                  </div>
          ...
          <div class="mobile-sidebar d-block d-lg-none">
            <div class="logo-m">
              <a href="index.html"><img src="{{ asset('landing/assets/img/logo/header-logo1.png')}}" alt=""></a>
            </div>
            ...
            <div class="row align-items-center">
              <div class="col-lg-6">
                <div class="main-heading">
                  <span class="span" data-aos="fade-right" data-aos-duration="800">Staffing Power Your Success </span>
                  <h1 class="text-anime-style-3">Growth Exceptional Talent Let's Build Success Together</h1>
              ...
              <div class="col-lg-6">
                <div class="hero1-images">
                  ...
                  <div class="image3 shape-animaiton2" data-aos="zoom-in-up" data-aos-duration="700">
                    <img src="{{ asset('landing/assets/img/shapes/review-img.png')}}" alt="">
                  </div>
              ...
              <div class="col-lg-12">
                <div class="logo-slider">
                  <div class="single-slider">
                    <img src="{{ asset('landing/assets/img/logo/slider-logo1.png')}}" alt="">
                  </div>
                  <div class="single-slider">
                    <img src="{{ asset('landing/assets/img/logo/slider-logo2.png')}}" alt="">
                  </div>
                  <div class="single-slider">
                    <img src="{{ asset('landing/assets/img/logo/slider-logo3.png')}}" alt="">
                  </div>
                  <div class="single-slider">
                    <img src="{{ asset('landing/assets/img/logo/slider-logo4.png')}}" alt="">
                  </div>
                  <div class="single-slider">
                    <img src="{{ asset('landing/assets/img/logo/slider-logo5.png')}}" alt="">
                  </div>
                  <div class="single-slider">
                    <img src="{{ asset('landing/assets/img/logo/slider-logo6.png')}}" alt="">
                  </div>
                  <div class="single-slider">
                    <img src="{{ asset('landing/assets/img/logo/slider-logo7.png')}}" alt="">
                  </div>
                  <div class="single-slider">
                    <img src="{{ asset('landing/assets/img/logo/slider-logo1.png')}}" alt="">
                  </div>
...
<div data-bs-spy="scroll" data-bs-target="#list-example" data-bs-offset="0" class="scrollspy-example" tabindex="0">
            ...
            <div class="chosse1 sp" id="choose">
                  ...
                  <div class="row align-items-center">
                    ...
                    <div class="col-lg-5">
                      <div class="image reveal overlay-anim">
                        <img src="{{ asset('landing/assets/img/others/choose1-img.png')}}" alt="">
                      </div>
                    </div>
                    <div class="col-lg-5">
                      <div class="heading1 choose1-heading">
                        ...
                        <div class="space16"></div>
                        <p data-aos="fade-left" data-aos-duration="900">Our team of industry experts is dedicated to understanding your unique needs and delivering tailored solutions that propel your business forward.</p>
                        ...
                        <div class="" data-aos="fade-left" data-aos-duration="1100">
                          <a class="theme-btn1" href="about.html">About US <span><i class="fa-solid fa-arrow-right"></i></span></a>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div class="service1 sp" id="service">
                <div class="container">
                  <div class="row">
                    <div class="col-lg-8 m-auto text-center">
                      <div class="heading1-w">
                        ...
                        <div class="space16"></div>
                        <p data-aos="fade-left" data-aos-duration="800"> With our proven track record and commitment to excellence, we're here to support your <br> organization's  growth and help you achieve your hiring goals.</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-lg-4 col-md-6">
                      <div class="service1-box" data-aos="zoom-in-up" data-aos-duration="700">
                        <div class="image overlay-anim">
                          <img src="{{ asset('landing/assets/img/service/service1-img1.png')}}" alt="">
                        </div>
                        <div class="hover-area">
                          <div class="icon">
                            <img src="{{ asset('landing/assets/img/icons/service1-icon1.png')}}" alt="">
                          </div>
                          <div class="space16"></div>
                          <div class="heading1-w">
                    ...
                    <div class="col-lg-4 col-md-6">
                      <div class="service1-box active" data-aos="zoom-in-up" data-aos-duration="900">
                        <div class="image overlay-anim">
                          <img src="{{ asset('landing/assets/img/service/service1-img2.png')}}" alt="">
                        </div>
                        <div class="hover-area">
                          <div class="icon">
                            <img src="{{ asset('landing/assets/img/icons/service1-icon2.png')}}" alt="">
                          </div>
                          <div class="space16"></div>
                          <div class="heading1-w">
                    ...
                    <div class="col-lg-4 col-md-6">
                      <div class="service1-box" data-aos="zoom-in-up" data-aos-duration="1100">
                        <div class="image overlay-anim">
                          <img src="{{ asset('landing/assets/img/service/service1-img3.png')}}" alt="">
                        </div>
                        <div class="hover-area">
                          <div class="icon">
                            <img src="{{ asset('landing/assets/img/icons/service1-icon3.png')}}" alt="">
                          </div>
                          <div class="space16"></div>
                          <div class="heading1-w">
                    ...
                    <div class="col-lg-12">
                      <div class="text-center" data-aos="zoom-in-up" data-aos-duration="700">
                        <a class="theme-btn3" href="service.html">Let’s get started <span><i class="fa-solid fa-arrow-right"></i></span></a>
                      </div>
                    </div>
              ...
              <section class="project-two d-none d-lg-block" id="project">
          ...
          <!--=====PROJECT AREA END=======-->
                ...
                <div class="row align-items-center">
                  <div class="col-lg-6">
                    <div class="work-img reveal overlay-anim">
                      <img src="{{ asset('landing/assets/img/work/work1-image.png')}}" alt="">
                    </div>
                  </div>
                  ...
                  <div class="col-lg-6">
                    <div class="heading1 work1-heading">
                      ...
                      <div class="space16"></div>
                      <p data-aos="fade-left" data-aos-duration="900">Whether you're seeking temporary assignments, placements, or executive-level positions, our curated</p>
                      ...
                      <div class="" data-aos="fade-left" data-aos-duration="900">
                        <div class="work1-box">
                          <div class="">
                            <div class="icon">
                              <img src="{{ asset('landing/assets/img/icons/work1-icon1.png')}}" alt="">
                            </div>
                          </div>
                          <div class="heading1">
                            <h4><a href="service-details.html">Sourcing the Best</a></h4>
                      ...
                      <div class="" data-aos="fade-left" data-aos-duration="700">
                        <div class="work1-box">
                          <div class="">
                            <div class="icon">
                              <img src="{{ asset('landing/assets/img/icons/work1-icon2.png')}}" alt="">
                            </div>
                          </div>
                          <div class="heading1">
                            <h4><a href="service-details.html">Volume Hiring</a></h4>
                      ...
                      <div class="" data-aos="fade-left" data-aos-duration="1100">
                        <div class="work1-box">
                          <div class="">
                            <div class="icon">
                              <img src="{{ asset('landing/assets/img/icons/work1-icon3.png')}}" alt="">
                            </div>
                          </div>
                          <div class="heading1">
                            <h4><a href="service-details.html">Partners in Team Building</a></h4>
            ...
            <div class="tes1 sp" id="testimonial">
              <div class="container">
                  ...
                  <div class="tes1-slider" data-aos="fade-up" data-aos-duration="900">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-4">
                          <div class="tes1-image">
                            <img src="{{ asset('landing/assets/img/testimonial/tes1-img1.png')}}" alt="">
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="single-slider">
                      <div class="row">
                        ...
                        <div class="col-md-4">
                          <div class="tes1-image">
                            <img src="{{ asset('landing/assets/img/testimonial/tes1-img2.png')}}" alt="">
                          </div>
                        </div>
                      </div>
                    </div>
            ...
            <div class="team1 sp">
              <div class="container">
                <div class="row">
                  <div class="col-lg-7 m-auto text-center">
                    <div class="heading1">
                      ...
                      <div class="space16"></div>
                      <p data-aos="fade-up" data-aos-duration="700">We take pride in fostering a collaborative environment where innovation <br> thrives and clients receive personalized attention at every step </p>
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-lg-4 col-md-6">
                    <div class="team1-box overlay-anim" data-aos="zoom-in-up" data-aos-duration="700">
                      <div class="image">
                        <img src="{{ asset('landing/assets/img/team/team1-img1.png')}}" alt="">
                      </div>
                      <div class="heading-area">
                        <div class="heading1">
                          <h4><a href="#">Sameer Rizvi</a></h4>
                  ...
                  <div class="col-lg-4 col-md-6">
                    <div class="team1-box overlay-anim" data-aos="zoom-in-up" data-aos-duration="900">
                      <div class="image">
                        <img src="{{ asset('landing/assets/img/team/team1-img2.png')}}" alt="">
                      </div>
                      <div class="heading-area">
                        <div class="heading1">
                          <h4><a href="#">Arshin Kulkarni</a></h4>
                          <p>VP, Finance</p>
                        </div>
                  ...
                  <div class="col-lg-4 col-md-6">
                    <div class="team1-box overlay-anim" data-aos="zoom-in-up" data-aos-duration="1100">
                      <div class="image">
                        <img src="{{ asset('landing/assets/img/team/team1-img1.png')}}" alt="">
                      </div>
                      <div class="heading-area">
                        <div class="heading1">
                          <h4><a href="#">Rachin Ravindra</a></h4>
                          <p>Senior Consultant</p>
                        </div>
                ...
                <div class="row">
                  <div class="col-lg-6">
                    <div class="blog1-box overlay-anim" data-aos="zoom-in-up" data-aos-duration="800">
                      <div class="image">
                        <img src="{{ asset('landing/assets/img/blog/blog1-img1.png')}}" alt="">
                      </div>
                      <div class="heading-area">
                        <div class="tags">
                          <a href="#"><img src="{{ asset('landing/assets/img/icons/date.png')}}" alt=""> Apl 2,2024</a>
                          <a href="#"><img src="{{ asset('landing/assets/img/icons/user.png')}}" alt=""> By Ethan Smith</a>
                        </div>
                        <div class="heading1">
                          <h4><a href="blog-details.html">Get the Scoop: Our Latest News & Announcements</a></h4>
                          <div class="space16"></div>
                          <p>Whether you're looking to navigate your career path or enhance</p>
                          <div class="blog1-border"></div>
                          <a href="blog-details.html" class="learn">Learn More <span><i class="fa-solid fa-arrow-right"></i></span></a>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-lg-6">
                    <div class="blog1-box overlay-anim" data-aos="zoom-in-up" data-aos-duration="900">
                      <div class="image">
                        <img src="{{ asset('landing/assets/img/blog/blog1-img2.png')}}" alt="">
                      </div>
                      <div class="heading-area">
                        <div class="tags">
                          <a href="#"><img src="{{ asset('landing/assets/img/icons/date.png')}}" alt=""> Apl 2,2024</a>
                        ...
                        <div class="heading1">
                          <h4><a href="blog-details.html">Industry Insights: Latest News & Developments</a></h4>
                          <div class="space16"></div>
                            ...
                            <div class="col-lg-4 col-md-6 col-12">
                                 <div class="single-footer-items footer-logo-area">
                                      <div class="footer-logo">
                                        <a href=""><img src="{{ asset('landing/assets/img/logo/footer-logo1.png')}}" alt=""></a>
                                      </div>
     ...
     <script src="{{ asset('landing/assets/js/fontawesome.js')}}"></script>
